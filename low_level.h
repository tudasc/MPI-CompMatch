...
//TODO the compiler does know if it should start a send or recv, test if it makes a difference, if we do not ned this if in the code
...
int MPIOPT_Send_init(const void *buf, int count, MPI_Datatype datatype, int dest,
